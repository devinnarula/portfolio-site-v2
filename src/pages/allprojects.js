...
import { ShapeWorld, Symptobot, LetsDraw, PortfolioV1, PortfolioV2, Puddle, ZigZagDodge, AlexaCanvas, Thesis, SwarmRobotics } from '../components/ProjectsSection/Data/projectdata'

const AllProjects = ({colorScheme}) => {
    const projects = [ShapeWorld, Symptobot, LetsDraw, PortfolioV1, PortfolioV2, Puddle, ZigZagDodge, AlexaCanvas, Thesis, SwarmRobotics]
